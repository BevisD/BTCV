...
```bash
python main.py --json_list=<jsons-path> --data_dir=<data-path> --feature_size=48 --use_ssl_pretrained\
...
```bash
python main.py --json_list=<jsons-path> --data_dir=<data-path> --feature_size=48 --noamp\
--roi_x=96 --roi_y=96 --roi_z=96  --use_checkpoint --batch_size=<batch-size> --max_epochs=<total-num-epochs> --save_checkpoint
```
...
```bash
python main.py --json_list=<jsons-path> --data_dir=<data-path> --feature_size=24\
...
```bash
python main.py --json_list=<jsons-path> --data_dir=<data-path> --feature_size=12\
--roi_x=96 --roi_y=96 --roi_z=96 --batch_size=<batch-size> --max_epochs=<total-num-epochs> --save_checkpoint
```
...
```bash
python main.py --json_list=<jsons-path> --data_dir=<data-path> --feature_size=48 \
